            ...
            <form method="POST" id="bulkForm">
                ...
                <div class="table-responsive">
                    <table class="admin-table">
                        ...
                        <tbody>
                            <?php foreach ($files as $fileId => $file): ?>
                            <tr>
                                <td class="checkbox-cell">
                                    <input type="checkbox" name="selected_files[]" value="<?= $fileId ?>" class="file-checkbox">
                                </td>
                                ...
                                <td>
                                    <button type="button" class="btn-copy" onclick="copyLink('<?= $fileId ?>')">Link</button>
